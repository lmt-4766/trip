...
<div class="image">
<img id="img" src="無題2.png" width="1990" height="400">

<div style="position: absolute; top: 30px; right:90px; max-width: 100%; max-height: 100%; padding: 0px;">
<a href="#">店舗一覧</a>
<a href="#">よくある質問</a>
...
<script type="text/javascript">
   ...
   var tabs = document.getElementById('tabcontrol').getElementsByTagName('a'); //id名
   var pages = document.getElementById('tabbody').getElementsByTagName('div'); //タブページ
